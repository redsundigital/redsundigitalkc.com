...
navlinks.forEach(navlink => {
    navlink.addEventListener("click", e => {
        ...
        navlink.innerHTML = navlinkActivePrefix + navlink.innerHTML + navlinkActiveSuffix;  // add prefix
...
function setNoLinksActive() {
    navlinks.forEach(navlink => {                                               // TODO: use regex for prefix & suffix
...
document.addEventListener("scroll", function (e) {
    ...
    else if (navscroll >= services.offsetTop && navscroll < portfolio.offsetTop) {
        setNavActive(1);
    }
...
function setNavActive(index) {
    ...
    navlinks[index].innerHTML = navlinkActivePrefix + links[index] + navlinkActiveSuffix;  // add prefix
